#include "StdAfx.h"
#include "UIFarm1BuildItem.h"
#include "GamePlugin.h"

#include <Components/Player/Player.h>
#include <CryEntitySystem/IEntitySystem.h>
#include <Components/BaseBuilding/BaseBuilding.h>
#include <Components/BaseBuilding/Buildings/Farm1Building.h>
...
UIFarm1BuildItem::UIFarm1BuildItem(IEntity* entity)
{
	this->m_pEntity = entity;
}

void UIFarm1BuildItem::Execute()
{
	if (!m_pEntity) {
	...
	if (actionManager) {
		...
		if (pBuildingEntity) {
			pBuildingEntity->GetOrCreateComponent<Farm1BuildingComponent>();
		}
	}
}
