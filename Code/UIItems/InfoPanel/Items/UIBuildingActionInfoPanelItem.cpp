#include "StdAfx.h"
#include "UIBuildingActionInfoPanelItem.h"
...
UIBuildingActionInfoPanelItem::UIBuildingActionInfoPanelItem(IEntity* entity, string imagePath, IBaseAction* action)
{
...
void UIBuildingActionInfoPanelItem::Execute()
{
	if (!m_pAction) {
...
string UIBuildingActionInfoPanelItem::GetImagePath()
{
	return m_imagePath;
}